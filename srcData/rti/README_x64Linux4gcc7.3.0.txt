...
data type TestType from test.idl.
This example builds two applications, named test_publisher and
test_subscriber.
...
> make -f makefile_test_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_test_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the test_publisher.cxx
file where it says:
...
Run /home/wangtao/dds/rti_connext_dds-7.3.0/resource/scripts/rtisetenv_x64Linux4gcc7.3.0.bash
...
> objs/x64Linux4gcc7.3.0/test_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/test_subscriber -d <domain_id> -s <sample_count>

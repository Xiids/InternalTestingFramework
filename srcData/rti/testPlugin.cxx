    ...
    void *containerPluginContext)
{
    try {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            TestTypePluginSupport_create_data,
...
RTIBool TestTypePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    TestType **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *TestTypePlugin_new(void) 
{ 
    ...
    */
    ...
    TestTypePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    TestTypePlugin_return_buffer;
    ...
    static const char * TYPE_NAME = "TestType";
...
void
TestTypePlugin_delete(struct PRESTypePlugin *plugin)
{
